...
from network_AGAN_QPAdaptation import AGAN
import utils

# !! please change to your path !!
ckp_path = 'F:/STDF-PyTorch-master-GAN-ATT/exp_QP22-37_att/MFQEv2_R3_enlarge300x/ckp_350000.pt' # model path
rec_yuv_save_path = 'G:/QP37/' # reconstructed video path (output path)
